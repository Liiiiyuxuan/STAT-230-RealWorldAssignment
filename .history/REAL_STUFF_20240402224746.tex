...
\begin{table}[ht]
    ...
    \\
    Straight Flush (non-Royal) & $\displaystyle \binom{9}{1} \binom{4}{1} \binom{4}{2}$          \\
    \\
...
\]
which is $2.781 \times 10^{12}$ for just 2 players. Since it isn’t realistic to go through all possible outcomes,
