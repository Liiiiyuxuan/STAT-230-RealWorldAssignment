...
\begin{table*}[ht]
    ...
    \end{tikzpicture} Two pairs & \( \displaystyle \frac{31,433,400}{133,784,560} \approx 23.5\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} One pair & \( \displaystyle \frac{58,627,800}{133,784,560} \approx 43.8\% \) \\ 
    \begin{tikzpicture}
    ...
    \end{tikzpicture} High hands & \( \displaystyle \frac{23,294,460}{133,784,560} \approx 17.4\% \) \\
    \hline
    \end{tabular}
\end{table*}
