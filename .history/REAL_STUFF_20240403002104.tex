...
\begin{tikzpicture}
    ...
    % Add headers
    \node[anchor=west] at (0.1, -0.3) {\textbf{Hand Type}};
    \node[anchor=east] at (5.9, -0.3) {\textbf{Frequency}};

    % Add rows
    \node[anchor=west] at (0.1, -0.9) {Pocket Pair};
    \node[anchor=east] at (5.9, -0.9) {5976};

    \node[anchor=west] at (0.1, -1.5) {Suited};
    \node[anchor=east] at (5.9, -1.5) {23167};

    \node[anchor=west] at (0.1, -2.1) {Unsuited};
    \node[anchor=east] at (5.9, -2.1) {70857};

    \node[anchor=west] at (0.1, -2.7) {Contains Ace or King};
    \node[anchor=east] at (5.9, -2.7) {28643};

    \node[anchor=west] at (0.1, -3.3) {Does Not Contain Ace or King};
    \node[anchor=east] at (5.9, -3.3) {71357};
\end{tikzpicture}
