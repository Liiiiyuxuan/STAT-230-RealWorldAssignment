...
ranks, there are 13 distinct pocket pairs (e.g. AA), 78 $\displaystyle 
\binom{13}{2}$ distinct suited 2-card combinations (e.g. AKs) and 78 $\displaystyle \binom{13}{2}$ distinct unsuited 
