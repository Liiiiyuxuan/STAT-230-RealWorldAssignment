...
The simulate_games function runs a specified number of poker games 
between two players, counting wins for each player and ties. For each game, it creates a deck, deals hands to players and community cards, then evaluates and compares these hands to determine the outcome. Wins for each player and ties are tallied and returned at the end, providing a summary of game results.
