...
\begin{table}[ht]
    ...
    \\
    Straight (excluding royal 
    flush and straight flush)  & $\displaystyle \binom{10}{1} \binom{4}{1}^5 - \binom{10}{1} \binom{4}{1}$           \\
    \\
    Three of a Kind            & $\displaystyle \binom{10}{1} \binom{4}{1}^5 - \binom{10}{1} \binom{4}{1}$            \\
    \\
    Two Pair                   & jj            \\
    \\
    One Pair                   & jj           \\
