...
$32.6\%$, and our probability of losing would be $100\%-32.6\% = 67.4\%$. Our gain would be equal to $\$80$, and our loss would be $\$30$ because we are essentially putting in $\$30$ to have a chance of winning the pot after our opponent has raised. Plugging these values into the formula, we obtain:
