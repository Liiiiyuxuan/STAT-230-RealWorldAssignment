...
\binom{13}{2}$ distinct suited 2-card combinations (e.g. AKs) and 78 
$\displaystyle \binom{13}{2}$ distinct unsuited 2-card combinations 
(e.g. AKo). It is intended to calculate the pre-flop (before any community cards are dealt) win rate for each distinct 2-card 
