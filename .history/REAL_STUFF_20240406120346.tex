...
between two players, counting wins for each player and ties. 
ds, then evaluates and compares these hands to determine the outcome. Wins for each player and ties are tallied and returned at the end, providing a summary of game results.
