...
either player. To provide a more precise statistical summary, measures 
such as the mean, median, or standard deviation would be required, but these are not calculable from the bar chart alone without the underlying numerical data.
