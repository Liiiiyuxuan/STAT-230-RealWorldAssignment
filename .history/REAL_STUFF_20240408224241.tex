...
\begin{enumerate}[ {[} 1 {]} ]
    \item A. Bărbulescu. Texas Hold'em Poker probabilities. Available at \url{http://probability.infarom.ro/holdempoker.html}
    \item PokerStrategy.com. Texas Hold'em probabilities. Available at \url{https://www.pokerstrategy.com/strategy/various-poker/texas-holdem-probabilities/}
    \item Wikipedia contributors. Poker probability. Wikipedia, The Free Encyclopedia. Available at \url{https://en.wikipedia.org/wiki/Poker_probability}
\end{enumerate}
