...
\begin{table*}[ht]
    ...
    \end{tikzpicture} Strait Flush & \qquad \( \displaystyle \frac{4,324}{133,784,560} \approx 0.0311\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Quad & \qquad \( \displaystyle \frac{224,848}{133,784,560} \approx 0.168\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Full House & \qquad \( \displaystyle \frac{3,473,184}{133,784,560} \approx 2.60\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Flush & \qquad \( \displaystyle \frac{4,047,644}{133,784,560} \approx 3.03\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Straight & \qquad \( \displaystyle \frac{6,180,020}{133,784,560} \approx 4.62\% \) \\ 
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Triple & \qquad \( \displaystyle \frac{6,461,620}{133,784,560} \approx 4.83\% \) \\ 
    \begin{tikzpicture}
    ...
    \end{tikzpicture} Two pairs & \qquad \( \displaystyle \frac{31,433,400}{133,784,560} \approx 23.5\% \) \\
    \begin{tikzpicture}
    ...
    \end{tikzpicture} One pair & \qquad \( \displaystyle \frac{58,627,800}{133,784,560} \approx 43.8\% \) \\ 
    \begin{tikzpicture}
    ...
    \end{tikzpicture} High hands & \qquad \( \displaystyle \frac{23,294,460}{133,784,560} \approx 17.4\% \) \\
    \hline
    \end{tabular}
\end{table*}
