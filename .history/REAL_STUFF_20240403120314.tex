...
$100 \; 000$ is chosen for this section:
\begin{align*}
...
that the probability of getting pocket pair(s) in a deck of 52 cards is
\[
    \underbrace{\frac{13 \cdot 12}{\binom{52}{4}}}_{\text{two pocket pairs}} 
    + \underbrace{\frac{13 \cdot \binom{50}{2}}{\binom{52}{4}}}_{\text{one pocket pair}}
    \approx 0.059400
\]
the probability for unsuited pair(s) is 
\[
    \frac{\binom{4}{2} \cdot 13 \cdot 13}{\binom{52}{4}}
    + \frac{12 \cdot 13}{\binom{52}{4}}
\]
